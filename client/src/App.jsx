  ...
  return (
    <Layout>
      <div style={{ maxWidth: 480, margin: '6rem auto', textAlign: 'center' }}>
        ...
        <p style={{ color: 'var(--muted)', marginBottom: '2rem' }}>{contenido.desc}</p>
...
function AppRoutes() {
  return (
    <Routes>
      ...
      <Route path="/vehicle/:id" element={<ConEmpresaRoute><VehicleDetail /></ConEmpresaRoute>} />

      {/* Solo usuarios SIN empresa */}
      <Route path="/company/create" element={<SinEmpresaRoute><CompanyCreate /></SinEmpresaRoute>} />
      <Route path="/company/list"   element={<SinEmpresaRoute><CompanyList /></SinEmpresaRoute>} />
